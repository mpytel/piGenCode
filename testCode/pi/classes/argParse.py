# argParse classes - synced from existing code

import os
import argparse
import shlex
import sys
from pi.defs.logIt import color, cStr
from pi.commands.commands import Commands, cmdDescriptionTagStr
        ...
        for cmdName in commands:
            ...
            for argName in arguments:
                if argName[-len(cmdDescriptionTagStr):] == cmdDescriptionTagStr:
                    ...
                    argHelp = cStr(f'  <{argName}> ',
                                   color.CYAN) + f'{arguments[argName]}'
